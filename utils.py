...
def net_builder(net_name, from_name: bool, net_conf=None):
    ...
    Args
        ...
        net_conf: When from_name is False, net_conf is the configuration of backbone
                  network (now, only WRN is supported).
    """
    if from_name:
        ...
        elif net_name == "RetFound":
            import models_vit

            return models_vit.__dict__["vit_large_patch16"]
        else:
